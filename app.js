...
return [ sum4 [0] , prod2 [0] , `${a} and ${b} and ${c} sum to 16.`,`The product of ${a} and ${b} and ${c} is 140.` ] ;
...
function multiplyArray(multArr) { 
        ...
        var total = 1;
        for (var h = 0 ; h<multArr.length ; h++) 
        {total = multiply(total , multArr[h])[0] ; }  //eslint-disable-line
